...
| Release-synced version | `0.01.028` |
...
- v0.01.028 is local-first; deployment packaging, desktop wrapping, and container workflows are not yet part of the shipped baseline.
