...
| Release-synced version | `0.01.026` |
...
- v0.01.026 is local-first; deployment packaging, desktop wrapping, and container workflows are not yet part of the shipped baseline.
