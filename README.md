...
| Release-synced version | `0.01.011` |
...
- v0.01.011 is local-first; deployment packaging, desktop wrapping, and container workflows are not yet part of the shipped baseline.
